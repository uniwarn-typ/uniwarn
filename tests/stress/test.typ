...
#context ([debug:(1):] + repr(state(my-namespace, 1).get()))
...
// 2.
#disable-warnings(my-namespace)
#context ([debug:(2):] + repr(state(my-namespace, 1).get()))
...
// 3.
#disable-warnings(my-namespace)
#context ([debug:(3):] + repr(state(my-namespace, 1).get()))
...
// 4.
#disable-warnings(my-namespace)
#context ([debug:(4):] + repr(state(my-namespace, 1).get()))
...
// 5.
#disable-warnings(my-namespace)
#context ([debug:(5):] + repr(state(my-namespace, 1).get()))
...
// 6.
#disable-warnings(my-namespace)
#context ([debug:(6):] + repr(state(my-namespace, 1).get()))
...
// 7.
#disable-warnings(my-namespace)
#context ([debug:(7):] + repr(state(my-namespace, 1).get()))
...
// 8.
#disable-warnings(my-namespace)
#context ([debug:(8):] + repr(state(my-namespace, 1).get()))
...
// 9.
#disable-warnings(my-namespace)
#context ([debug:(9):] + repr(state(my-namespace, 1).get()))
...
// 10.
#disable-warnings(my-namespace)
#context ([debug:(10):] + repr(state(my-namespace, 1).get()))
